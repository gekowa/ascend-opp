   ...
   """
    ...
    if list(shape_x) == list(shape_y):
        ...
        input2 = gen_param(classify="input2", name="alpha",
                           datatype=",".join(alpha_dtypes),
                           format=",".join(alpha_formats))
...
@fusion_manager.register("axpy_v2")
...
@check_op_params(REQUIRED_INPUT, REQUIRED_INPUT, REQUIRED_INPUT, OPTION_OUTPUT,
                 KERNEL_NAME)
