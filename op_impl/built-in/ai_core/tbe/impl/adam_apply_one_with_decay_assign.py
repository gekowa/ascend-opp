...
@fusion_manager.register("adam_apply_one_with_decay_assign")
...
def adam_apply_one_with_decay_assign(input0,
    ...
    input_place0 = tvm.placeholder(shape0, name="input0__" + kernel_name, dtype=dtype0)
    input_place1 = tvm.placeholder(shape1, name="input1__" + kernel_name, dtype=dtype1)
    input_place2 = tvm.placeholder(shape2, name="input2__" + kernel_name, dtype=dtype2)
    input_place3 = tvm.placeholder(shape3, name="input3__" + kernel_name, dtype=dtype3)
    input_place4 = tvm.placeholder(shape4, name="input4__" + kernel_name, dtype=dtype4)

    input_cm0 = tvm.placeholder(shapecm0, name="const_mul_x__" + kernel_name, dtype=dtypecm0)
    input_cm1 = tvm.placeholder(shapecm1, name="const_mul1_x__" + kernel_name, dtype=dtypecm1)
    input_cm2 = tvm.placeholder(shapecm2, name="const_mul2_x__" + kernel_name, dtype=dtypecm2)
    input_cm3 = tvm.placeholder(shapecm3, name="const_mul3_x__" + kernel_name, dtype=dtypecm3)
    input_cm4 = tvm.placeholder(shapecm4, name="const_mul4_x__" + kernel_name, dtype=dtypecm4)

    input_y = tvm.placeholder(shapey, name="add2_y__" + kernel_name, dtype=dtypey)

    y1, y2, y3 = adam_apply_one_with_decay_assign_compute(
    ...
    # Fusion with assign
    util.reuse_input_as_output(input_place1, y1, kernel_name)
    util.reuse_input_as_output(input_place2, y2, kernel_name)
    util.reuse_input_as_output(input_place3, y3, kernel_name)
