...
def _less_compare(data, shape, dtype, data_min):
    ...
    if dtype == "float32":
        ...
        res = te.lang.dynamic.vmuls(res_mul2, tvm.const(SCALAR_MUL1_FP32, dtype=dtype))
    elif dtype == "float16":
        ...
        res = te.lang.dynamic.vmuls(res_mul1, tvm.const(SCALAR_MUL_FP16, dtype=dtype))
    else:
        res = te.lang.dynamic.cast_to(res_max, "float16")
