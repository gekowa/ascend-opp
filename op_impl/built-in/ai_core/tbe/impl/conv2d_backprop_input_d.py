...
def conv2d_backprop_input_d_compute( # pylint: disable=C0103,W0622,R0913,R0914
        filter, out_backprop, y, input_size,
        strides, pads, dilations=(1, 1, 1, 1),
        groups=None, data_format="NHWC", # pylint: disable=W0613
        kernel_name="conv2d_backprop_input"):
    """
    used for fusion
    Parameters
...
@util.check_input_type((list, tuple), (list, tuple), (list, tuple),
                       ...
                       str,
                       str)
def conv2d_backprop_input_cce(# pylint: disable=R0913,R0914
        shape_filter, shape_out_backprop, input_sizes,
        strides, pads, dilations=(1, 1, 1, 1),
